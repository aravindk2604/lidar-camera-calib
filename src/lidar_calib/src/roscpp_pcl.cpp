...
/*
	...
	pass_y.setFilterLimits(-4.5, 4.5); // limiting between - and + 4.5 metres of data
	pass_y.filter (*cloud_filtered);
	
	pass_z.setFilterFieldName ("z");
	pass_z.setFilterLimits(-4.5, 4.5); // limiting between - and + 4.5 metres of data
	pass_z.filter (*cloud_filtered);
*/	

	//std::cout << "size: " << cloud->size() << std::endl; //"  hei: " << cloud->height << std::endl;
