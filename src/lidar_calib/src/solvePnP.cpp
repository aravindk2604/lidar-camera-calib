/**
 * This program takes a set of corresponding 2D and 3D points and finds the
 * transformation matrix that best brings the 3D points to their corresponding
 * 2D points.
 */
...
int main(int argc, char *argv[]) {
  ...
  std::cout << "There are " << imagePoints.size() << " imagePoints and "
            << objectPoints.size() << " objectPoints." << std::endl;
  ...
  std::cout << "obj: " << objectPoints.size()
            << " img: " << projectedPoints.size() << std::endl;
